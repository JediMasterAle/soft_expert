<template>
  <h1 class="text-center text-h3">Produtos</h1>
  <div class="q-ma-md">
...
import typeServiceApi from "src/services/type";
...
//Tabel
const { list,post,remove,update } = productService();
...
const postItens = async(form) =>{
  ...
  getItens();
  plus_input.value=[
  { label: "Código", type: "text", name: "code", value: "" },
  { label: "Produto", type: "text", name: "name", value: "" },
  { label: "Valor", type: "text", name: "value", value: "" },
  { label: "Tipo do produto", type: "select", name: "types_id", value: "",options:options },
  ]
}
...
const columns = [
  ...
  { name: "value_withou_tax", align: "left", label: "Valor sem imposto", field: "value_withou_tax" },
  { name: "types_name", align: "left", label: "Tipo", field: "types_name" },
  { name: "types_tax", align: "left", label: "Imposto", field: "types_tax" },
...
function handleLineClicked(value) {
  ...
  update_input.value=[
    ...
    { label: "Código", type: "text", name: "code", value: data.code },
    { label: "Produto", type: "text", name: "name", value: data.name },
    { label: "Valor", type: "text", name: "value", value: data.value },
    { label: "Tipo do produto", type: "select", name: "types_id", value: data.types_id,options:options },
  ]
